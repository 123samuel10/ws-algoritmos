...
document.getElementById("enviar").onclick = function enviar() {
    ...
    const capturar = function capturar(producto1, cantidad1, precio1, producto2, cantidad2, precio2, producto3, cantidad3, precio3, productoNumeroCuatro, cantidadNumeroCuatro, precio4, producto5, cantidad5, precio5, producto6,
...
document.getElementById("precioMenor").onclick = function precioMenor() {
    baseDedato.forEach(element => {
...
document.getElementById("vaciarCompra").onclick = function() {
